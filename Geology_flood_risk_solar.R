...
writeRaster(suitability_geology,
            "C:/Temp_R/geology_suitability.tif",
            overwrite=TRUE)
#_____________________________________________________________________________#

# Load flood risk data
eng_flood_risk <- st_read("C:/Temp_R/Flood_Risk_Areas.shp/Flood_Risk_Areas.shp")
...
writeRaster(suitability_flood,
            "C:/Temp_R/non_floodrisk_suitability.tif",
            overwrite=TRUE)
...
writeRaster(suitability_solar,
            "C:/Temp_R/solar_suitability.tif",
            overwrite=TRUE)
